show_ram() {
  ...
  tmux set-option -g @ram_low_bg_color "$thm_black4"     # background color when ram is low
  tmux set-option -g @ram_medium_bg_color "$thm_magenta" # background color when ram is medium
