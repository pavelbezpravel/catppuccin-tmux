show_cpu() {
  ...
  tmux set-option -g @cpu_low_bg_color "$thm_black4"     # background color when cpu is low
  tmux set-option -g @cpu_medium_bg_color "$thm_magenta" # background color when cpu is medium
